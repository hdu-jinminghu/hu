...
def change_control(job,trainCycle_):
    ...
    f.close()
    controldata = "@".join([readtag, modeltype, tag, cycle, paramConq, nodeId, monitorList,appendix,prunList,keep,structPath,dataPath,dropout,batchsize,trainCycle_])
