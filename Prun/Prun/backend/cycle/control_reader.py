...
def change_control(job,cycle_):
    ...
    f.close()
    controldata = "@".join([readtag, modeltype, tag, cycle_, paramConq, nodeId, monitorList,appendix,prunList,keep,structPath,dataPath,dropout,batchsize,trainCycle])
